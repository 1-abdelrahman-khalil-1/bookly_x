...
// import 'package:akhi_go/app/core/data/locale/user_pref.dart';
...
//   static Future<void> subscribeToAll(List<String> newTopics) async {
//     await _firebaseMessaging.subscribeToTopic('all');
//     for (var topic in newTopics) {
//       await _firebaseMessaging.subscribeToTopic(topic);
//     }
//     await UserPrefs.setUserTopic(newTopics);
//   }

//   static Future<void> unsubscribeFromAll() async {
//     final topics = await UserPrefs.getUserTopic();
//     if (topics != null) {
