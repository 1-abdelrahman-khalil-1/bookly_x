...
import 'package:bookly_x/app/features/client/bookings/presentation/widgets/booking_card.dart';
import 'package:bookly_x/app/features/client/bookings/presentation/widgets/booking_tab_bar.dart';
                        ...
                        children: _currentBookings.map((booking) {
                          return SizedBox(
                            ...
                            child: BookingCard(
                              ...
                              onTap: () => context.push(
                                  ClientBookingDetailsRoute(booking: booking)),
