...
const clientOffersAllCategoryId = 'all';
const clientOffersSpaCategoryId = '1';
const clientOffersClinicCategoryId = '3';
const clientOffersBarberCategoryId = '2';

const _clientMockOffers = [
  OfferModel(
    id: 'o1',
    imageUrl:
  ...
  OfferModel(
    id: 'o3',
    imageUrl:
        'https://images.unsplash.com/photo-1596704017254-9f8e23e577fc?w=800&h=400&fit=crop',
    discount: '30%',
  ),
  OfferModel(
    id: 'o4',
...
const _clientMockProviders = [
  ProviderModel(
    ...
    verified: true,
    category:
        CategoryModel(id: clientOffersSpaCategoryId, name: 'SPA', image: ''),
  ),
  ProviderModel(
    id: 'p2',
    name: 'Samer Youssef',
  ...
  ProviderModel(
    ...
    category: CategoryModel(
      id: clientOffersBarberCategoryId,
      name: 'Barber',
      image: '',
    ),
  ),
  ...
  ProviderModel(
    ...
    verified: true,
    category: CategoryModel(
      id: clientOffersClinicCategoryId,
      name: 'Clinic',
      image: '',
    ),
  ),
...
final clientOffersSelectedCategoryProvider =
    StateProvider<String>((ref) => clientOffersAllCategoryId);

final clientOffersFutureProvider =
    FutureProvider<List<OfferModel>>((ref) async {
  await Future.delayed(const Duration(milliseconds: 700));
  return _clientMockOffers;
});

final clientOffersProvidersFutureProvider =
    FutureProvider.family<List<ProviderModel>, String>((ref, categoryId) async {
  await Future.delayed(const Duration(milliseconds: 700));

  if (categoryId == clientOffersAllCategoryId) {
    return _clientMockProviders;
  }

  return _clientMockProviders
      .where((provider) => provider.category.id == categoryId)
      .toList();
});
