...
class OfferVerticalCard extends StatelessWidget {
  final ProviderModel provider;

  const OfferVerticalCard({super.key, required this.provider});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ProviderDetailsRoute(providerId: provider.id).push(context);
      },
      child: Container(
